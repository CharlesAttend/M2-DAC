...
\Cref{fig:phi_gaussian} illustrate a comparison between the predictions made by a RBF Gaussian Regression model and the actual ground truth. 

% ptit shift dans la moyenne a un endorit et ça modifie la tête de la sinusoide, donc très fitted sur les données
