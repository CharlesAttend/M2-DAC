...
rotation, flips, zoom in/out, change perspective, affine transformation, change color/brightness/contrast/saturation/hue/sharpness, gaussian blur, polarize, solarize, erase pixels,  permute channels, grayscale, 
...
\begin{figure}[H]
    ...
    \caption{Comparison of schedulers on SGD}
