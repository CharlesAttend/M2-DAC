...
\begin{itemize}
    \item conv1: 32 filters of 5 by 5 $\rightarrow 32*5*5 = 800$ parameters
    \item conv1: 64 filters of 5 by 5 $\rightarrow 64*5*5 = 1600$ parameters
    \item conv1: 64 filters of 5 by 5 $\rightarrow 64*5*5 = 1600$ parameters
    \item 1000 neurons with a 1024 values as input $\rightarrow 1000*1024=1,024,000$ parameters
    \item 10 neurons with a 1000 values as input $\rightarrow 10*1000=10,000$ parameters
\end{itemize}
It makes a total of $ 116,400 $ parameters to train with 60,000 (6000 images per class). Tt should be ok.
%%%%%%%%%%%%%%%%
% IS IT OK ?????
%%%%%%%%%%%%%%%%
