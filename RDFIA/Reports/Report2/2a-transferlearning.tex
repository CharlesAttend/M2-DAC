...
In \Cref{fig:vgg16}, we present the results of applying our network to four different images: two relatively common pictures of a tuxedo cat and a dog, along with two more whimsical images one might come across on the internet. The first of these whimsical images is a close-up photo of a wombat, and the second is a photomontage featuring a dog.

This figure illustrates how the images are preprocessed to fit our network's architecture. The third row showcases the model's best predictions. Remarkably, the model accurately classifies each image, even successfully identifying the breed for both cat and dogs.
