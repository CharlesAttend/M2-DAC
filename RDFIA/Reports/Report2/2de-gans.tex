...
For a detailed reference, please consult the training curves in \Cref{fig:longer_epochs_losses}, where the 5-epoch mark corresponds to 2300 steps, and review the generated images in \Cref{fig:GAN_default}.
...
However, our observations align with the findings of the authors, suggesting that increasing the learning rate and $\beta_1$ in Adam can make the GAN learn too quickly, which can negatively impact training stability and the quality of generated images. The training curves can be found in Appendix \Cref{appendix:gan_lr}. 
