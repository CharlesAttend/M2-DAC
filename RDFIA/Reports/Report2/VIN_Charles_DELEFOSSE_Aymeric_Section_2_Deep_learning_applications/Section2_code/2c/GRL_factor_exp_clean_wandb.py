...
Fait une unique run  wanb avec juste la perf à la dernière epoch : donc on n'a pas les stats du training mais juste un graph simple sans trop de bordel dans wandb
"""
