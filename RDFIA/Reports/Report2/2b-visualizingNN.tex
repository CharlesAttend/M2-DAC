...
% préciser les valeurs de régu ? => Complexe car c'est un combo, un peu chaint à écrire, bluering everimage + 1e-2, ça me semble pas important en vrai
...
\begin{figure}[H]
    ...
    \end{subfigure}
    \caption{Class visualization of Wombat. (a) Using SqueezeNet for comparison; (b) Using VGG with default regularizations; (c) Using VGG with strong regularization.}
