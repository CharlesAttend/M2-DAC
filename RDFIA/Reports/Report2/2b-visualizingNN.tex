...
% figure où le modèle misclassify des images?
...
\begin{figure}[H]
    ...
    \begin{subfigure}{.5\textwidth}
        \centering
        % \includemedia[width=.7\linewidth, height=.7\linewidth]{}{SqueezeNet/SqueezeNet_wombat_animated_1000.mp4}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{.33\textwidth}
        \centering
        % \includemedia[width=.7\linewidth, height=.7\linewidth]{}{SqueezeNet/SqueezeNet_bird_animated_same_init_img_reg++.gif}
        \caption{\href{figs/2b/SqueezeNet\_bird\_animated\_same\_init\_img\_reg++.gif}{Animation} starting from same class.} %(see \textit{SqueezeNet\_bird\_animated\_same\_init\_img\_reg++.gif})}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{.5\textwidth}
        \centering
        % \includemedia[width=.7\linewidth, height=.7\linewidth]{}{SqueezeNet/SqueezeNet_snail_animated_init_img_reg++.gif} 
