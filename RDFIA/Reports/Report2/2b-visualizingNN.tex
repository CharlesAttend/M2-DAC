...
\begin{figure}[H]
    ...
    \begin{subfigure}{.33\textwidth}
        ...
        \end{frame}
        \caption{} %(see \textit{SqueezeNet\_bird\_animated\_same\_init\_img\_reg++.gif})}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{.33\textwidth}
        ...
        \end{frame}
        \caption{\href{gifs/SqueezeNet_snail_animated_init_img_reg++.gif}{Animation}}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{.5\textwidth}
        ...
        \end{frame}
        \caption{\href{gifs/VGG_snail_animated_init_img_reg++.gif}{Animation}}
