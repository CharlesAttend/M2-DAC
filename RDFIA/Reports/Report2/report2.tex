...
2. 1000 because 1000 classes
3. 


5. VGG from scratch, pas assez de donnée pour le gros model, risque fort d'overfitting 
6. What's the assumption behind transfert learning : the data are somehow simililar 
