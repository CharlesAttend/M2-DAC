...
Durant ce cours, nous nous focaliserons spécifiquement sur trois architectures classiques de ResNet, détaillées dans la \Cref{tab:resnetArchitectures} ci-dessous. Il serait également pertinent d'explorer une quatrième architecture, qui intégrerait plusieurs couches linéaires ou convolutives.
...
\begin{proposition}[Admis]\label{prop1}
    Soient les modèles \texttt{res-1}, \texttt{res-2}, \texttt{res-3} décrit dans la \Cref{tab:resnetArchitectures}, on a \begin{itemize}
