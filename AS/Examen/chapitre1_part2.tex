...
L'\Cref{H4} s'applique à toutes les architectures répertoriées dans la \Cref{tab:resnetArchitectures}, comme le démontre la proposition suivante.
\begin{proposition}\label{prop5}
    Soit les réseaux \texttt{res-1}, \texttt{res-2} et \texttt{res-3} définit dans la \Cref{tab:resnetArchitectures}. Supposons l'\Cref{H1} satisfaite et $ \sigma  $ dérivable presque partout avec $ a \leqslant \sigma ^\prime \leqslant b $. Alors
    \begin{itemize}
...
\begin{cor}\label{cor8}
    ...
    \begin{enumerate}
        ...
        .\]
    \end{enumerate}
    Ce corrolaire est illustré dans la \Cref{fig:cor8}.
\end{cor}
